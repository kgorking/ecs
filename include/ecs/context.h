...
namespace ecs::detail {
	...
	private:
		...
		auto& create_system_impl(UserUpdateFunc update_func)
		{
			...
			using typed_system_impl = system_impl<ExecutionPolicy, UserUpdateFunc, std::remove_cv_t<std::remove_reference_t<FirstArg>>, std::remove_cv_t<std::remove_reference_t<Args>>...>;
