...
int main() {
    ...
    // Handle damage logic
    ecs.make_system<ecs::opts::interval<1000.0 / infection::dmg_tick>>([](ecs::entity_id self, health& h, infection const&) {
    ...
    // Handle spread logic
    ecs.make_system<ecs::opts::interval<1000.0 / infection::spread_tick>>([&ecs](ecs::entity_id self, infection const& p) {
    ...
    // Handle spell logic
    ecs.make_system<ecs::opts::interval<1000.0 / 10>>([&ecs](ecs::entity_id self, infection& p, health const& h) {
        p.duration -= 100;
